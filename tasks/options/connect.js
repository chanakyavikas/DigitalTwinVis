...
var config = {
    ...
    proxy: {
        '/api/asset': {
            url: 'https://digital-twin-dt-tutorial-asset.run.aws-usw02-pr.ice.predix.io',
            instanceId: 'foo',
            pathRewrite: {'^/api/asset': '/asset'}
        },
        '/api/result': {
            url: 'https://digital-twin-dt-tutorial-result-persistence.run.aws-usw02-pr.ice.predix.io',
            instanceId: 'foo',
